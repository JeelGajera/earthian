    ...
    <Layout section = "About Me" title = "Jeel Gajera | About 😌" >
        <div className="flex-col items-center justify-center">
          ...
          <div className="m-5">
            ...
            <motion.div
              initial={"hidden"} animate={"visible"} variants={secLeftToRight}
          ...
          <div className="m-5">
            ...
            <motion.div 
            initial={"hidden"} animate={"visible"} variants={secRightToLeft}
            className="ml-4 p-2 bg-black bg-opacity-20 backdrop-blur-md rounded">
              <ul className="ml-4 text-md list-disc marker:text-[#f8b34b]">
                ...
                <li className="list-none p-1">
                  ...
                  <span className="font-mono rounded text-gray-400 text-md bg-white bg-opacity-10">2018 - Continue</span>
                  <ul className="ml-4 text-md list-disc marker:text-[#f8b34b]">
