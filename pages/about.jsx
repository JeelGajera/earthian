      ...
      <div ref={ref3} className="m-5">
        ...
        <motion.div
          ...
          <ul className="ml-4 text-md list-disc marker:text-[#f8b34b]">
            ...
            <li>Currently, I'm in the 4<sup>th</sup> year of graduation. I just started exploring this field but, I have a little bit experience of in competitive programming.</li>
